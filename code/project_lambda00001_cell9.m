...
feature_params = struct('template_size', 36, 'hog_cell_size', 9);

%% Step 1. Load positive training crops and random negative examples

features_pos = get_positive_features( train_path_pos, feature_params );

% original num of examples : 60000
% TODO : change the # of examples later in
...
imwrite(hog_template_image, 'visualizations/hog_template_lambda00001_cell9.png')
pause(0.1);
